---
title: Security
description: Security considerations, best practices, and vulnerability reporting for Windows-MCP
---

<Warning>
**READ THIS BEFORE DEPLOYING WINDOWS-MCP**

Windows-MCP is **NOT** a sandboxed or isolated tool. It interacts **directly with your actual Windows operating system** on behalf of the connected LLM agent. Many operations **CANNOT BE UNDONE**.
</Warning>

## Overview

Windows-MCP provides powerful automation capabilities that interact directly with your Windows operating system. This page outlines critical security considerations, best practices, and our commitment to maintaining a secure project.

## Critical Warnings

### Direct Operating System Interaction

Windows-MCP executes real actions on your physical or virtual Windows machine:

- **Real System Actions**: Every tool call executes real actions on your Windows system
...
Windows-MCP operates with the same permissions as the user running it:
...
Refer to `main.py` in the source code for complete tool annotations.
